...
public class DatabaseInit implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        clienteRepository.save(new Cliente(12345L, "juanchito@gmail.com", "3216547414", "Juan Andres Orjueña Bello", "Activo"));
        clienteRepository.save(new Cliente(67890L, "pipe@gmail.com", "3163597104", "Daniel Felipe Bello Navas", "Activo"));

        clienteRepository.save(new Cliente(1L, "ana.perez@gmail.com", "3012345678", "Ana Pérez", "Inactivo"));
        clienteRepository.save(new Cliente(2L, "juan.garcia@gmail.com", "3023456789", "Juan García", "Activo"));
        clienteRepository.save(new Cliente(3L, "maria.lopez@gmail.com", "3034567890", "María López", "Activo"));
        clienteRepository.save(new Cliente(4L, "pedro.martinez@gmail.com", "3045678901", "Pedro Martínez", "Activo"));
        clienteRepository.save(new Cliente(5L, "luisa.ramirez@gmail.com", "3056789012", "Luisa Ramírez", "Activo"));
        clienteRepository.save(new Cliente(6L, "carlos.gomez@gmail.com", "3067890123", "Carlos Gómez", "Inactivo"));
        clienteRepository.save(new Cliente(7L, "sofia.mora@gmail.com", "3078901234", "Sofía Mora", "Activo"));
        clienteRepository.save(new Cliente(8L, "david.herrera@gmail.com", "3089012345", "David Herrera", "Activo"));
        clienteRepository.save(new Cliente(9L, "natalia.mendoza@gmail.com", "3090123456", "Natalia Mendoza", "Activo"));
        clienteRepository.save(new Cliente(10L, "jorge.flores@gmail.com", "3101234567", "Jorge Flores", "Activo"));
        clienteRepository.save(new Cliente(11L, "valentina.ortiz@gmail.com", "3112345678", "Valentina Ortiz", "Activo"));
        clienteRepository.save(new Cliente(12L, "alvaro.castro@gmail.com", "3123456789", "Álvaro Castro", "Activo"));
        clienteRepository.save(new Cliente(13L, "laura.martinez@gmail.com", "3134567890", "Laura Martínez", "Activo"));
        clienteRepository.save(new Cliente(14L, "martin.cano@gmail.com", "3145678901", "Martín Cano", "Activo"));
        clienteRepository.save(new Cliente(15L, "carla.uribe@gmail.com", "3156789012", "Carla Uribe", "Activo"));
        clienteRepository.save(new Cliente(16L, "esteban.vera@gmail.com", "3167890123", "Esteban Vera", "Inactivo"));
        clienteRepository.save(new Cliente(17L, "camila.suarez@gmail.com", "3178901234", "Camila Suárez", "Activo"));
        clienteRepository.save(new Cliente(18L, "oscar.rodriqez@gmail.com", "3189012345", "Óscar Rodríguez", "Inactivo"));
        clienteRepository.save(new Cliente(19L, "juliana.valencia@gmail.com", "3190123456", "Juliana Valencia", "Activo"));
        clienteRepository.save(new Cliente(20L, "andres.carrillo@gmail.com", "3201234567", "Andrés Carrillo", "Activo"));
        clienteRepository.save(new Cliente(21L, "veronica.salazar@gmail.com", "3212345678", "Verónica Salazar", "Activo"));
        clienteRepository.save(new Cliente(22L, "gustavo.jimenez@gmail.com", "3223456789", "Gustavo Jiménez", "Inactivo"));
        clienteRepository.save(new Cliente(23L, "daniela.torres@gmail.com", "3234567890", "Daniela Torres", "Activo"));
        clienteRepository.save(new Cliente(24L, "sebastian.murillo@gmail.com", "3245678901", "Sebastián Murillo", "Activo"));
        clienteRepository.save(new Cliente(25L, "angela.romero@gmail.com", "3256789012", "Ángela Romero", "Inactivo"));
        clienteRepository.save(new Cliente(26L, "nicolas.pineda@gmail.com", "3267890123", "Nicolás Pineda", "Activo"));
        clienteRepository.save(new Cliente(27L, "martha.silva@gmail.com", "3278901234", "Martha Silva", "Activo"));
        clienteRepository.save(new Cliente(28L, "alexander.rios@gmail.com", "3289012345", "Alexander Ríos", "Activo"));
        clienteRepository.save(new Cliente(29L, "paola.garzon@gmail.com", "3290123456", "Paola Garzón", "Activo"));
        clienteRepository.save(new Cliente(30L, "jose.mendoza@gmail.com", "3301234567", "José Mendoza", "Activo"));
        clienteRepository.save(new Cliente(31L, "elena.moreno@gmail.com", "3312345678", "Elena Moreno", "Activo"));
        clienteRepository.save(new Cliente(32L, "samuel.estrella@gmail.com", "3323456789", "Samuel Estrella", "Activo"));
        clienteRepository.save(new Cliente(33L, "carolina.ortega@gmail.com", "3334567890", "Carolina Ortega", "Activo"));
        clienteRepository.save(new Cliente(34L, "javier.martinez@gmail.com", "3345678901", "Javier Martínez", "Activo"));
        clienteRepository.save(new Cliente(35L, "catalina.vargas@gmail.com", "3356789012", "Catalina Vargas", "Inactivo"));
        clienteRepository.save(new Cliente(36L, "martin.fernandez@gmail.com", "3367890123", "Martín Fernández", "Inactivo"));
        clienteRepository.save(new Cliente(37L, "isabella.castano@gmail.com", "3378901234", "Isabella Castaño", "Inactivo"));
        clienteRepository.save(new Cliente(38L, "manuel.palomino@gmail.com", "3389012345", "Manuel Palomino", "Inactivo"));
        clienteRepository.save(new Cliente(39L, "lina.quintero@gmail.com", "3390123456", "Lina Quintero", "Activo"));
        clienteRepository.save(new Cliente(40L, "santiago.garcia@gmail.com", "3401234567", "Santiago García", "Activo"));
        clienteRepository.save(new Cliente(41L, "silvia.morales@gmail.com", "3412345678", "Silvia Morales", "Activo"));
        clienteRepository.save(new Cliente(42L, "juanita.morales@gmail.com", "3423456789", "Juanita Morales", "Activo"));
        clienteRepository.save(new Cliente(43L, "fabian.garcia@gmail.com", "3434567890", "Fabian García", "Activo"));
        clienteRepository.save(new Cliente(44L, "maria.flores@gmail.com", "3445678901", "María Flores", "Activo"));
        clienteRepository.save(new Cliente(45L, "roberto.moreno@gmail.com", "3456789012", "Roberto Moreno", "Activo"));
        clienteRepository.save(new Cliente(46L, "valeria.perez@gmail.com", "3467890123", "Valeria Pérez", "Inactivo"));
        clienteRepository.save(new Cliente(47L, "raul.bermudez@gmail.com", "3478901234", "Raúl Bermúdez", "Activo"));
        clienteRepository.save(new Cliente(48L, "gloria.ramirez@gmail.com", "3489012345", "Gloria Ramírez", "Activo"));
        clienteRepository.save(new Cliente(49L, "andrea.carrillo@gmail.com", "3490123456", "Andrea Carrillo", "Inactivo"));
        clienteRepository.save(new Cliente(50L, "santiago.perez@gmail.com", "3501234567", "Santiago Pérez", "Inactivo"));
